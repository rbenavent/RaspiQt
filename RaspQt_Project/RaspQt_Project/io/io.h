...
public:
    ...
    */
    explicit io(bool AppRestart, unsigned int warningTimeut_ms = 2000, unsigned int restartTimeut_ms = 10000, unsigned int appRestart_ms = 0, QObject* parent = nullptr);
    ~io() override;
signals:
